...
class SSEConnection:
    ...
    async def send_event(self, event_type: str, data: Dict[str, Any], event_id: Optional[str] = None) -> bool:
        """Send an SSE event.
...
class SSEConnectionManager:
    ...
    async def add_connection(self, request: Request) -> SSEConnection:
        ...
        self.logger.info(f"New SSE connection: {connection_id} (total: {len(self.connections)})")
    ...
    def remove_connection(self, connection_id: str) -> None:
        ...
        if connection_id in self.connections:
            ...
            self.logger.info(f"Removed SSE connection: {connection_id} (remaining: {len(self.connections)})")
    
    async def broadcast_event(self, event_type: str, data: Dict[str, Any], event_id: Optional[str] = None) -> int:
    ...
    async def send_to_connection(self, connection_id: str, event_type: str, data: Dict[str, Any], event_id: Optional[str] = None) -> bool:
...
class SSETransport(TransportBase):
    ...
    def __init__(self, host: str = "localhost", port: int = 8080, heartbeat_interval: int = 30):
    ...
    async def _handle_sse_connection(self, request: Request) -> StreamResponse:
        ...
        try:
            ...
            try:
                ...
                await self._handle_connection_event("disconnect", connection.connection_id)
    ...
    async def send_message(self, message: Dict[str, Any]) -> None:
        ...
        sent_count = await self.connection_manager.broadcast_event(event_type, event_data, event_id)
    ...
    async def send_to_connection(self, connection_id: str, message: Dict[str, Any]) -> bool:
        ...
        return await self.connection_manager.send_to_connection(connection_id, event_type, event_data, event_id)